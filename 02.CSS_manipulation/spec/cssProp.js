...
describe('cssProp', function () {
  ...
  xit('should set multiple CSS properties of an HTML element', function () {
  ...
  xit('should properly set CSS properties if called multiple times on different HTML elements', function () {
